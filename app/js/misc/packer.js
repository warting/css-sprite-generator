...
Author:
	IvÃ¡n Montes <drslump@drslump.biz>, <http://blog.packer.es>
...
// Create a packer namespace object if it doesn't exists
...
/*
	Constructor: packer.RectanglePacker
...
*/
packer.RectanglePacker = function ( width, height ) {
...
/*
	...
	Parameters:
		...
		height - The containing rectangle maximum height as integer
*/
packer.RectanglePacker.prototype.reset = function ( width, height ) {
	this.root.x = 0;
	this.root.y = 0;
	this.root.w = width;
	this.root.h = height;
...
*/
packer.RectanglePacker.prototype.getDimensions = function () {
...
/*
	...
	Returns:
		...
		If it doesn't fit returns false
*/
...
packer.RectanglePacker.prototype.findCoords = function ( w, h ) {
